...
Private Const IdProduit As Long = 5
Private Const Produit As String = "Struct-Urb"
Private Const Guid As String = "{807CC7B4-312B-4413-ABED-D851C00F1DD3}"
Private Const Vermaj As Long = 2
Private Const Vermin As Long = 0
Private Const message As String = "its-StructUrb"
